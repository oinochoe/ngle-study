...
<rss version="2.0">
    <channel>
        ...
        <link>http://localhost:8080/post/list</link>
        <description><![CDATA[아카이브, 블로그, 커뮤니티 서비스]]></description>
        <language>ko-kr</language>
        <generator>https://gitlab.com/noel86/private</generator>
        <c:forEach var="post" items="${postList}">
            <item>
                <title><![CDATA[<c:out value="${post.title}" escapeXml="true" />]]></title>
                <link>http://localhost:8080/post/${post.id}</link>
                <description>
                ...
                <guid>http://localhost:8080/post/${post.id}</guid>
